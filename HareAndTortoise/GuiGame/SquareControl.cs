...
namespace GuiGame {
    ...
    public partial class SquareControl : PictureBox {
        ...
        private void LoadImageWhenNeeded() {
            ...
            if (square.Number == 5 || square.Number == 15 || square.Number == 25 || square.Number == 35)
            {
            ...
            else if (square.Number == 10 || square.Number == 20 || square.Number == 30 || square.Number == 40)
            {
